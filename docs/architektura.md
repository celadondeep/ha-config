...
| | Šeškiniai SE (1-a) | Eimo SE (2-a) |
|---|---|---|
| Vieta | Šeškinių k., Bartninkų sen., Vilkaviškio r. (54.456, 23.024) | Gražiškiai, Vilkaviškio r. (54.468, 22.921) |
| Ryšys | **Lokalus Modbus** (solis_modbus) | **Solis Cloud** (solis + solis_cloud_control) |
| Inverteris | Solis S6-EH3P, 10 kW | 1033300254190112 |
| Entities | `solis_s6_eh3p_*` | `*_eimo`, `inverter_control_1033300254190112_*`, `solis_inverter_1033300254190112_*` |
...
- **Inverterius valdo tik automations.yaml / packages/eimo.yaml** — per
  charge/discharge slotus ir work_mode.
...
- **AppDaemon addon** — `/config/appdaemon/apps`, atskiras git →
  ...
  keliai per `__file__`.
- **Solcast** (HACS) — viena svetainė („seskiniu_2", kalibruota Šeškinių
